classdef PIVlabApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            PIVlabApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'PIVlab_GUI')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong PIVlab_GUI
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'PIVlab_GUI').getString, ...
            ...
            if nargout(@PIVlab_GUI) == 0
                eval('PIVlab_GUI');
            else
                obj.AppHandle = eval('PIVlab_GUI');
            end
