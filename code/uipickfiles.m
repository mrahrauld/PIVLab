...
uicontrol('Position',[10 425+30 80 16],...
	...
	'HorizontalAlignment','left',...
    'Visible', 'off')
showallfiles = uicontrol('Position',[10 445+40 200 20],...
	'Style','checkbox',...
	'String','Show All Files in Current Directory',...
	'Value',0,...
	'HorizontalAlignment','left',...
	'Callback',@togglefilter,'tooltipstring','Show also non-image files');
% PIVlab_select = uicontrol('Position',[10 445+20 200 20],...
% 	'Style','radiobutton',...
% 	'String','Sequencing style 1-2, 2-3, 3-4, ...',...
% 	'Value',0,...
% 	'HorizontalAlignment','left',...
% 	'Callback',@PIVlab_select_Callback,'tooltipstring','Image sequencing style');
% PIVlab_select2 = uicontrol('Position',[10 445-0 200 20],...
% 	'Style','radiobutton',...
% 	'String','Sequencing style 1-2, 3-4, 5-6, ...',...
% 	'Value',1,...
% 	'HorizontalAlignment','left',...
% 	'Callback',@PIVlab_select_Callback2,'tooltipstring','Image sequencing style');
uicontrol('Position',[10 445+20 200 20],...
	'Style','text',...
	'String','set sequencing jump',...
	'HorizontalAlignment','left',...
    'Visible', 'on')
img_jumping = uicontrol('Position',[10 445-0 200 20],...
	'Style','edit',...
	'BackgroundColor','w',...
	'String','2',...
	'HorizontalAlignment','left',...
    'Visible', 'on','tooltipstring','');

filter_ed = uicontrol('Position',[10 445+30 80 20],...
	'Style','edit',...
	'BackgroundColor','w',...
	'String',filter,...
	'HorizontalAlignment','left',...
...
refilter_ed = uicontrol('Position',[10 480+30 160 20],...
	'Style','edit',...
	'BackgroundColor','w',...
	'String',re_filter,...
	'HorizontalAlignment','left',...
...
uicontrol('Position',[10 425 160 16],...
	'Style','text',...
	'String','set image spacing',...
	'HorizontalAlignment','left',...
    'Visible', 'on')
 
img_spacing = uicontrol('Position',[10 405 160 20],...
	'Style','edit',...
	'BackgroundColor','w',...
	'String',re_filter,...
	'HorizontalAlignment','left',...
	'Callback',@setimgspacing,...
    'Visible', 'on','tooltipstring','Example:  \.m$|\.mat$  will list files ending in ''.m'' and ''.mat''.');
...
try
	...
	function done(varargin)
        ...
        imgjumping = get(img_jumping,'String');
        if isempty(imgjumping) % If default value
            imgjumping = '1';
        end
        imgjumping = str2num(imgjumping);
        if isempty(imgjumping) % If not an integer
				msg = {'sequencing jump must be an integer.','Please change its value'};
				uiwait(errordlg(msg,'','modal'))
				return
        else
            hgui=getappdata(0,'hgui');
            setappdata(hgui, 'imgjumping', imgjumping);
        end
    ...
    function setimgspacing(varargin)
    end
end
